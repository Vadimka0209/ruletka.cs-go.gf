...
<head> <title>CSGOEvo - Evolve your skins!</title> 
<base > <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"> 
<meta name="author" content="CSGOEvo.com"/> 
<meta name="keywords" content="jackpot, CSGOEvo, bestpot, gambling, csgo, counter strike global offensive"> <meta name="description" content="The best CSGO Jackpot Gambling on CSGOEvo only. Looking for money? Looking for knives and expensive items? Come gamble!"> 
...
<li class="separator"></li> <li class="mini"><a href="http://support.CSGOEvo.com/" class="support" target="_blank"><i class="fa fa-life-ring">
...
<a href="index.php" class="sitename transition" data-page="play">CSGO<span class="transition">Evo</span>.com - Evolve your skins!</a><ul id="right-section"> 

<li class="el promo leadtext">Add <span>CSGOEvo.com</span> to your steam name and get <span>+6%</span> bonus<br/> to your winnings! (relog website)</li> 
...
while($rowd=mysql_fetch_array($query)):
  ...
  <?php endwhile; ?>
   ...
   <h2>CSGOEvo - Rules/FAQ</h2> <h3>Evolve Your Skins!</h3>
...
- Your first deposit gives you a +5% win chance.<br/>- By adding "CSGOEvo.com" to your steam name and re-logging the site, you get +6% extra on your winnings!<br/><h4>Current Promotions:</h4>
...
- The site takes 10% commission (4% with CSGOEvo.com) for upkeep, advertising, give-aways and site development.
...
Accounts/Privacy:</h4> The account you authorize with us through Steam (https://steamcommunity.com) must be your own. Your privacy is kept 100% secure and will never be distributed externally. 
   <h4>Fair Play</h4>
   We respect fair play. A MAXIMUM of 4% will be taken from jackpot winners with "CSGOEvo.com" and up to 10% without for further website development, give-aways and upkeep. All users on this website are expected to be "legit" users of the community as we hold the right to freeze your account without warning if suspicion is raised.
   <h4>Missing Items</h4> 
   If you are missing any items deposited or returned from CSGOEvo.com, you have 30 days to claim your items through a support ticket. You will be notified after 30 days. Items will not be returned if put into the jackpot and lost. All jackpot betting are FINAL.
   <h4>Valuation:</h4> CSGOEvo items are valued from SteamAnalyst's database backed up with the Steam Market. Prices are subjected to change any time without notice. <br/> All deposits are final after the user confirms them on the website, there will be no refunds, since the user agrees to enter the jackpot. Agrees he is liable to losing
	   ...
	   <h4>Skin Deposits:</h4> CSGOEvo.com only allows items from game “Counter Strike: Global Offensive” (non-affiliated). These skins MUST be your own.Items from different games will be declined. 
	   <h4>Variation:</h4>
        CSGOEvo.com may revise these terms and conditions at all time. Revised terms and conditions will apply to the use of this website from the date of the publication of the revised terms and conditions on this website. Please check this page regularly to ensure you are familiar with the current version. 
		...
		The third-party links that are shown outside CSGOEvo.com is not our responsibility. We are unaffiliated unless mentioned. That includes the content, privacy, or practices of external parties.
